...
parser.add_argument('--dynamic_train', action='store_false',
                    help="dynamically extract enclosing subgraphs on the fly")
parser.add_argument('--dynamic_val', action='store_false')
parser.add_argument('--dynamic_test', action='store_false')
